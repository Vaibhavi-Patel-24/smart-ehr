...
const NotificationCard = ({user}) => {
    ...
    const { name, phone, location, time } = user
  return (
    <>
    ...
    <div className="z-10 shadow-2xl flex justify-center items-center border-2 w-[90%] sm:w-[80%] md:w-[65%] lg:w-[60%] h-[45%] lg:h-[15%]  py-6 rounded-[15px] px-6 sm:px-10 border-[#0095DA] bg-white/90 backdrop-blur-lg">
        <div className="flex flex-col items-center gap-4 w-full">
          <div className='flex flex-col lg:flex-row  gap-3 lg:gap-5'>
            <p className='font-bold text-red-600 flex flex-row gap-1'><span><img src={user_blue} alt='Name: ' style={{ width: '20px', height: 'auto' }} /></span><span>{name}</span><span className='text-[rgb(0,149,218)] hidden lg:inline'>|</span></p>
